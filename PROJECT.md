...
| 屏 RST | 26 | `EPD_RST` | ✅ |
| 屏 BUSY | 25 | `EPD_BUSY` | ✅ |
| 屏幕电源开关 | **21** | `EPD_PWR` | ⚠️ 微雪拓扑：默认(悬空/高)=屏幕常开，GPIO 拉低=关屏断电；平时输出高，仅关机拉低（勿用 strapping 脚） |
...
| 32 | NC | (未用) | 悬空 |
| 33 | IO21 | **EPD_PWR** 屏幕供电开关 | 输出；电路默认(悬空/高)=常开屏，软件平时置高、仅关机拉低断电；硬件 R35 需贴(约1k~2.2k)才能软件控 |
